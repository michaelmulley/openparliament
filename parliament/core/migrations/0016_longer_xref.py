...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InternalXref.text_value'
        db.alter_column(u'core_internalxref', 'text_value', self.gf('django.db.models.fields.CharField')(max_length=250))


    def backwards(self, orm):
        
        # Changing field 'InternalXref.text_value'
        db.alter_column(u'core_internalxref', 'text_value', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'core.internalxref': {
            ...
            'text_value': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '250', 'blank': 'True'})
        },
        u'core.party': {
