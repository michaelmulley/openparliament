...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('hansards_statement', 'h1_fr', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True), keep_default=False)

        # Adding field 'Statement.h2_fr'
        db.add_column('hansards_statement', 'h2_fr', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True), keep_default=False)

        # Adding field 'Statement.h3_fr'
        db.add_column('hansards_statement', 'h3_fr', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True), keep_default=False)
    ...
    models = {
        ...
        'hansards.statement': {
            ...
            'h1_fr': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
            'h2': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
            'h2_fr': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
            'h3': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
            'h3_fr': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
