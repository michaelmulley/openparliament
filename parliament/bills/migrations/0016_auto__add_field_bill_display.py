...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bill.display'
        db.add_column('bills_bill', 'display', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Bill.display'
        db.delete_column('bills_bill', 'display')
